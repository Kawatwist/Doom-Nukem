...
/*   Updated: 2019/07/08 14:55:09 by lomasse          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	inputmulti(t_win *wn) // => CHOIX DU MENU HOST OU CLIENT
{
	...
	!(wn->flag & CONSOLE) && key_pressed(wn, SDL_SCANCODE_ESCAPE) ? wn->interface = MGAME : 0;
	!(wn->flag & CONSOLE) && key_pressed(wn, SDL_SCANCODE_ESCAPE) ? wn->menu->choice = 10 : 0;
