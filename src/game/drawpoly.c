...
/*   Updated: 2019/06/11 13:50:10 by jsauron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			maindrawpoly(t_win *wn)
{
	...
	while (curr != NULL)
	{
		...
		curr->normal = ft_calculate_normal_of_points(curr->ver_tmp[curr->indices[i]], curr->ver_tmp[curr->indices[i + 1]], curr->ver_tmp[curr->indices[i + 2]]);
		printf("up->x = %f\n", curr->normal.x);
		printf("up->y = %f\n", curr->normal.y);
		printf("up->z = %f\n", curr->normal.z);
//		calc_fsu(wn, curr->ver_tmp, curr); 
