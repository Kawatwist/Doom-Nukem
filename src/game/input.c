...
/*   Updated: 2019/04/12 17:07:55 by lomasse          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(wn->player->rawx += (XSCREEN / 2 - wn->input->x)) > XSCREEN ? wn->player->rawx = 0 : 0;
	(wn->player->rawy += (wn->input->y - (YSCREEN / 2))) > YSCREEN ? wn->player->rawy = YSCREEN : 0;
